...
const DirectionsPage = () => {
    return (
        <div>
            <Hero title={" Find Your Way to Our Shop"} description={"We’re easy to find and work with. Get directions, view our map, and plan your visit to your trusted repair experts just a short drive away."} image={"/src/assets/images/about.jpg"}></Hero>
