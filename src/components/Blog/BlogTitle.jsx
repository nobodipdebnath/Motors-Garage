...
const BlogTitle = () => {
    return (
        <div className='mx-[7%] mt-30'>
            ...
            <h1 className='text-[40px] font-bold text-black-accent mt-7'>Why Regular Oil Changes Are the Heartbeat of Your Engine</h1>
            <p className='text-lg text-black-base mt-3'>Getting a grip on how your diet affects your mental health is super important for feeling your best. What you munch on can really <br /> change your mood and energy levels, so it's worth paying attention to!</p>
